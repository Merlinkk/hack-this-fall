...
const initialMessages: Message[] = [
  {
    id: '1',
    text: 'Hello! I\'m **Nirogya AI**, your health assistant. How can I help you with your health today?',
    sender: 'ai',
    timestamp: new Date(),
  },
];
...
export default function ChatPage() {
  ...
  // Translations
  const healthChat = useTranslatedText('Health Chat');
  const chatSubtitle = useTranslatedText('Chat with Nirogya AI for health guidance');
  const searchPlaceholder = useTranslatedText('Search messages...');
  const typeMessage = useTranslatedText('Type your message...');
  const addMessage = useTranslatedText('Add a message (optional)...');
  const aiThinking = useTranslatedText('AI is thinking...');
    ...
    >
              ...
              <Card className="p-3.5 sm:p-4 rounded-2xl bg-gray-50 border-gray-200 shadow-sm">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-sm sm:text-base text-gray-600">
                    {toolExecuting ? `Using ${toolExecuting}...` : aiThinking}
                  </span>
                </div>
              </Card>
            </div>
      ...
      >
        ...
        >
          ...
          <Input
            type="text"
            placeholder={selectedImage ? addMessage : typeMessage}
            value={inputValue}
